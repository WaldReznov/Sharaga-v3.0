...
namespace WindowsFormsApplication1
{
    public partial class LWP02Main : Form
    {
        ...
        private void BO2_Click(object sender, EventArgs e)
        {
            if (Clear == true)
            {
                ResultBox.Clear();
        ...
        private void BO4_Click(object sender, EventArgs e)
        {
            if (Clear == true)
            {
                ResultBox.Clear();
        ...
        private void BO5_Click(object sender, EventArgs e)
        {
            if (Clear == true)
            {
                ResultBox.Clear();
        ...
        private void BO6_Click(object sender, EventArgs e)
        {
            if (Clear == true)
            {
                ResultBox.Clear();
        ...
        private void BO7_Click(object sender, EventArgs e)
        {
            if (Clear == true)
            {
                ResultBox.Clear();
        ...
        private void BO8_Click(object sender, EventArgs e)
        {
            if (Clear == true)
            {
                ResultBox.Clear();
        ...
        private void BO9_Click(object sender, EventArgs e)
        {
            if (Clear == true)
            {
                ResultBox.Clear();
        ...
        private void BO0_Click(object sender, EventArgs e)
        {
            if (Clear == true)
            {
                ResultBox.Clear();
